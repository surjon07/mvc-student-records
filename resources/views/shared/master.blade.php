...
<head>
  ...
  <title>
      @yield('title') | Student Records
  </title>

  <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Roboto+Slab:400,700|Material+Icons" />
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css">
  <link href="{{ asset ('material-dashboard/assets/css/material-dashboard.css?v=2.1.2') }}" rel="stylesheet" />
...
<body class="">
  ...
  <script src="{{ asset ('material-dashboard/assets/js/material-dashboard.js?v=2.1.2" type="text/javascript') }}"></script>
